...
class BasicClientActor(BasicClientActorAbs):
    ...
    def __init__(self, IP_address=None, verbose=True):
        ...
        self.agent = Agent(model=keras.models.load_model("./{}".format(oht_agent)))
    ...
    def handle_get_action(self, state):
        ...
        legal_moves = get_legal_moves(state, size=6)
        next_move = legal_moves[np.argmax(predictions)]
        return next_move
